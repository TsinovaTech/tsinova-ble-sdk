 ...
 */
public class BikeBlueToothUtils {

	private final static String SERVICE_UUID = "0000ff00";//服务uuid 0000ff00-0000-1000-8000-00805f9b34fb

	private final static String CHAR_PROPERTIES_NOTIFY_UUID = "0000ff01";//能够接收 0000ff01-0000-1000-8000-00805f9b34fb

	private final static String CHAR_PROPERTIES_WRITE_UUID = "0000ff02";//能够发送0000ff02-0000-1000-8000-00805f9b34fb
     ...
     * @return
     */
    public static boolean isBikeService(UUID uuid){
    	if(uuid == null){
    		return false;
    	}
    	String str = uuid.toString();
    	if(str.startsWith(SERVICE_UUID)){
    		return true;
    	} else {
    		return false;
    	}
    ...
    public static boolean isBikeCharNotifyProperties(UUID uuid){
    	if(uuid == null){
    		return false;
    	}
    	String str = uuid.toString();
    	if(str.startsWith(CHAR_PROPERTIES_NOTIFY_UUID)){
    		return true;
    	} else {
    		return false;
    	}
    }
    public static boolean isBikeCharWriteProperties(UUID uuid){
    	if(uuid == null){
    		return false;
    	}
    	String str = uuid.toString();
    	if(str.startsWith(CHAR_PROPERTIES_WRITE_UUID)){
    		return true;
    	} else {
    		return false;
    	}
