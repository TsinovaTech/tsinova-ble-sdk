...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED =
            SingletonBTInfo.INSTANCE.getPackageName() + ".le.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED =
            SingletonBTInfo.INSTANCE.getPackageName() + ".le.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED =
            SingletonBTInfo.INSTANCE.getPackageName() + ".le.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_AVAILABLE =
            SingletonBTInfo.INSTANCE.getPackageName() + ".le.ACTION_DATA_AVAILABLE";
    public final static String ACTION_DATA_WRITE_CALLBAK =
            SingletonBTInfo.INSTANCE.getPackageName() + ".le.ACTION_DATA_WRITE_CALLBAK";
    public final static String EXTRA_DATA = SingletonBTInfo.INSTANCE.getPackageName() + ".le.EXTRA_DATA";
